...
const CoursesPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    specialization: "",
    duration: { years: 4 },
    fees: { year1: 0, year2: 0, year3: 0, year4: 0 },
    hostelFees: { year1: 0, year2: 0, year3: 0, year4: 0 },
  });
  ...
  const columns = [
    ...
    { field: "degree", headerName: "Degree", minWidth: 100 },
    {
      ...
      headerName: "Duration",
      minWidth: 100,
      renderCell: (row) => `${row.duration?.years || 4} Years`,
    },
    {
      field: "fee",
      headerName: "Year 1 Fee",
      minWidth: 120,
      renderCell: (row) => formatCurrency(row.fees?.year1),
    },
    {
      field: "isActive",
      headerName: "Status",
          ...
          <Box>
            <Tooltip title="Edit">
              <IconButton
                ...
                onClick={() => {
                  setEditCourse(row);
                  setFormData({ ...row, collegeId: row.collegeId?._id });
                  setDialogOpen(true);
                }}
              >
                <Edit fontSize="small" />
  ...
  return (
    <Box>
      <PageHeader
        ...
        actionLabel={isSuperAdmin || isAdmin ? "Add Course" : null}
        onActionClick={() => {
          setEditCourse(null);
          setFormData({
            name: "",
            ...
            <Grid item xs={3}>
              <TextField
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    duration: { years: parseInt(e.target.value) },
                  })
                }
              />
            </Grid>
